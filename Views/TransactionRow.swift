    ...
    var body: some View {
        HStack(spacing: 8) {
            ...
            Button(action: {
                    ...
                    // Forzar actualización de la vista y recálculo de totales
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        if transaction.type == .gp {
                            ...
                            if transaction.type == .expense || transaction.type == .subscription {
                                if let nextChargeDate = getNextChargeDate(transaction: transaction) {
