...
class WidgetDataProvider {
    ...
    private func calculateWidgetDataFromTransactions() -> WidgetData {
        ...
        // Suscripciones (excluir transacciones futuras)
        ...
        // Total de ingresos - (todos los gastos: gastos normales + suscripciones + gastos personales)
        let totalGastosCombinados = totalGastos + totalSuscripciones + totalGP
        let beneficio = totalIngresos - totalGastosCombinados
        
        print("WidgetDataProvider: Cálculo directo de beneficio:")
        print("- Total Ingresos: \(totalIngresos)")
        print("- Total Gastos Combinados: \(totalGastosCombinados) = Gastos(\(totalGastos)) + Suscripciones(\(totalSuscripciones)) + GP(\(totalGP))")
