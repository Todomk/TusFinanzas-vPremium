...
enum PaymentMethod: String, CaseIterable, Codable {
    ...
    case bizum = "Bizum"
    case custom = "custom" // Caso especial para métodos personalizados
    
    // Propiedad calculada para obtener el nombre visible del método
    var displayName: String {
        // El caso custom se manejará de forma especial en las vistas
...
enum GPCategory: String, CaseIterable, Codable {
    ...
    // Propiedad calculada para obtener el nombre visible de la categoría
    var displayName: String {
        return self.rawValue
    }
}
...
struct Transaction: Identifiable, Codable {
    ...
    var customPaymentMethod: String? // Método de pago personalizado
    var paymentDay: Int?
    var weekDay: WeekDay?
    ...
    var customGPCategory: String? // Categoría personalizada
    ...
    // Método para obtener el nombre del método de pago (con soporte para personalizados)
    func getPaymentMethodName() -> String {
        if paymentMethod == .custom, let customName = customPaymentMethod {
            return customName
        }
