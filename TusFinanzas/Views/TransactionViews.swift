                ...
                trailing: Button("Guardar") {
                    if let amount = Double(amount),
                       !concept.isEmpty {
                        ...
                        // Validar la fecha para gastos y suscripciones
                        if (type == .expense || type == .subscription) {
                            ...
                            let isBeforeCurrentMonth = startComponents.year! < currentComponents.year! || 
                                                      (startComponents.year! == currentComponents.year! && 
                                                       startComponents.month! < currentComponents.month!)
                        ...
                        if type == .expense && !periodicity.isValidForExpense {
                        ...
                        // Si hay un método de pago personalizado, guardarlo en una variable separada
                        if let customMethod = customPaymentMethod {
                            transaction.customPaymentMethod = customMethod
                        }
