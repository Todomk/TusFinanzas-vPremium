...
struct EditGPTransactionView: View {
    ...
    init(transaction: Transaction, onSave: ((Transaction) -> Void)? = nil) {
                ...
                trailing: Button("Guardar") {
                    if let amount = Double(amount),
                       !concept.isEmpty {
                        ...
                        // Calcular los meses de aparición para esta transacción
                        ...
                        if let saveCallback = onSave {
                            ...
                            saveCallback(updatedTransaction)
                        } else {
